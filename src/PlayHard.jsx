...
import englishWords from '../src/assets/7_letter_words.json'
...
export default function PlayHard({ rows, columns, words }) {
    ...
    const handleSubmit = () => {
        ...
        console.log(currentRowInputCheck.toLowerCase());
        if (!englishWords.some(o => o.word === currentRowInputCheck.toLowerCase())) {
